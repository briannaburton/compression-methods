...
[binary_stream, binary] = arithmetic_encoding([1,2,3,4], [0.5,0.3,0.15,0.05], [1,2,3,1,4,2])

%Generate the arithmetic coding for "BE_A_BE"
[binary_stream, binary] = arithmetic_encoding([1,2,3,4], [0.375,0.25,0.25,0.125], [2,1,3,4,3,2,1,1])
